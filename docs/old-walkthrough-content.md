...
![making brakeman job](screenshots-orig/10_brakemanJobCreation.png)
...
![brakeman job add repo](screenshots-orig/11_brakemanAddBranchSource.png)
![brakeman job Jenkinsfile path](screenshots-orig/12_brakemanSpecifyJenkinsfilePath.png)
...
![brakeman job start](screenshots-orig/13_brakemanBuildStarts.png)
...
![brakeman job complete](screenshots-orig/14_brakemanSuccesfulRun.png)
...
![making arachni job](screenshots-orig/15_arachniJobCreation.png)
...
![arachni job add repo](screenshots-orig/16_arachniRepoAdd.png)
![arachni job Jenkinsfile path](screenshots-orig/17_arachniBranchSource.png)
...
![arachni job starts](screenshots-orig/18_arachniBuildStarts.png)
...
![arachni job console](screenshots-orig/19_arachniJobConsole.png)
...
![arachni job complete](screenshots-orig/20_arachniSuccesfulRun.png)
